...
A primary goal of [GDG Cebu](https://gdgcebu.org/) is to be inclusive to the largest number of contributors, with the most varied and diverse backgrounds possible. As such, we are committed to providing a friendly, safe and welcoming environment for all, regardless of gender, sexual orientation, ability, ethnicity, socioeconomic status, and religion (or lack thereof).
...
- Shad Roi de la Cruz, +63 923 120 6325, [shad@gdgcebu.org](mailto:shad@gdgcebu.org)
